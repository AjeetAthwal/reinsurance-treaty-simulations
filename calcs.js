...
function createXoLTreatyLossGenerator(distributionType, distributionParameters, attachment, limit, numLosses) {
    ...
    const xolGenerator = new XoLTreatyLossGenerator({ parameters: generator.parameters }, xolTreaty);

    const grossLosses = generator.generateLosses(numLosses);
    const netLosses = xolGenerator.generateLosses(numLosses);
